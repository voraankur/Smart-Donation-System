...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEnterpriseJPanel(JPanel userProcessContainer, DonationSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Manage Enterprise");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(network.getEnterpriseDirectory().getEnterpriseList().size()>0){
            JOptionPane.showMessageDialog(null, "Only one enterprise can be created");
            return;
        }
