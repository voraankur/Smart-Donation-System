...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEnterpriseAdminJPanel(JPanel userProcessContainer, DonationSystem system) {
        initComponents();
        ...
        usernameJTextField.setInputVerifier(myNameVerifier);
        nameJTextField.setInputVerifier(myNameVerifier);
        passwordJPasswordField.setInputVerifier(myNameVerifier);
    }
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(enterprise.getPersonDirectory().getPersonList().size() > 0 ){
            JOptionPane.showMessageDialog(null, "Enterprise can not have more than one admin");
        }
        else{
                 Person admin= new SysAdmin();
        
        enterprise.getPersonDirectory().getPersonList().add(admin);
        UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, admin, new AdminRole());
        populateTable();
        }
