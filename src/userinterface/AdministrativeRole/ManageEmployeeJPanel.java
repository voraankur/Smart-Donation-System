...
import static Business.Organization.Organization.Type.Recipient;
import Business.Organization.OrganizationDirectory;
import Business.Organization.RecipientOrganization;
import Business.Organization.UserVerificationOrganization;
import Business.People.AppliancesHead;
import Business.People.ClothesHead;
import Business.People.MiscHead;
import Business.People.Recipient;
import Business.People.UserVerificationDeptPerson;
...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
       ...
       organization.getPersonDirectory().getPersonList().add(recipient);
       ...
       AppliancesHead appliancesHead= new AppliancesHead();
       
       organization.getPersonDirectory().getPersonList().add(appliancesHead);
       
       appliancesHead.setName(name);
       }
       
       if (organization instanceof ClothesOrganization){
          
       
       ClothesHead clothesHead= new ClothesHead();
       
       organization.getPersonDirectory().getPersonList().add(clothesHead);
       clothesHead.setName(name);
       }
       
       if (organization instanceof MiscOrganization){
          
       
       MiscHead miscHead= new MiscHead();
       
       organization.getPersonDirectory().getPersonList().add(miscHead);
       miscHead.setName(name);
       }
       
       if (organization instanceof UserVerificationOrganization){
          
       
       UserVerificationDeptPerson userVerificationPerson= new UserVerificationDeptPerson();
       
       organization.getPersonDirectory().getPersonList().add(userVerificationPerson);
       userVerificationPerson.setName(name);
       }
